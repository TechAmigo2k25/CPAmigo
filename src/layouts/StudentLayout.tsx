...
const navItems = [
  ...
  { path: "/student/problems", icon: FileCode, label: "Problems" },
  { path: "/student/quiz", icon: BarChart3, label: "Quiz" }
...
export default function StudentLayout({ children }: StudentLayoutProps) {
  ...
  return (
    // ✅ FIX 1: Lock full height + prevent body scroll
    <div className="h-screen flex bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* Mobile Header */}
        <header className="lg:hidden shrink-0 flex items-center justify-between p-4 border-b border-border bg-card">
          <button
